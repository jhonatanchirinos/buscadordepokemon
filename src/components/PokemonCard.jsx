...
const PokemonCard = ({ name, image, imageShiny, isShiny, types }) => {
  ...
  return (
    <div
      className="group flex flex-col items-center p-3 sm:p-4 border-3 border-gray-700/50 rounded-2xl shadow-sm hover:shadow-xl hover:border-blue-500/50 transition-all duration-300 transform hover:-translate-y-1 h-full cursor-pointer"
      style={{ backgroundColor: bgColor }}
    >
      <div
        className="w-full aspect-square flex items-center justify-center rounded-xl mb-3 overflow-hidden"
